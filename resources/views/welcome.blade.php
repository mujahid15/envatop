...
<head>
    ...
    <link rel="stylesheet" href="{{asset('theme/css/fontello.css')}}">
    <link rel="stylesheet" href="{{asset('theme/css/jquery-ui.css')}}">
    <link rel="stylesheet" href="{{asset('theme/css/lnr-icon.css')}}">
    <link rel="stylesheet" href="{{asset('theme/css/owl.carousel.css')}}">
    <link rel="stylesheet" href="{{asset('theme/css/slick.css')}}">
    <link rel="stylesheet" href="{{asset('theme/css/trumbowyg.min.css')}}">
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-3 col-6 v_middle">
                        <div class="logo">
                            <a href="index.html">
                                <img src="{{url('theme/images/logo.png')}}" alt="logo image" class="img-fluid">
                            </a>
                        </div>
                    </div>
                    <!-- end /.col-md-3 -->
                        ...
                        <div class="author-area">
                                        ...
                                        <div class="dropdown notification--dropdown">
                                            ...
                                            <div class="notifications_module">
                                                <div class="notification">
                                                    <div class="notification__info">
                                                        <div class="info_avatar">
                                                            <img src="{{url('theme/images/notification_head.png')}}" alt="">
                                                        </div>
                                                        <div class="info">
                                                            <p>
                                                ...
                                                <div class="notification">
                                                    <div class="notification__info">
                                                        <div class="info_avatar">
                                                            <img src="{{url('theme/images/notification_head2.png')}}" alt="">
                                                        </div>
                                                        <div class="info">
                                                            <p>
                                                ...
                                                <div class="notification">
                                                    <div class="notification__info">
                                                        <div class="info_avatar">
                                                            <img src="{{url('theme/images/notification_head3.png')}}" alt="">
                                                        </div>
                                                        <div class="info">
                                                            <p>
                                                ...
                                                <div class="notification">
                                                    <div class="notification__info">
                                                        <div class="info_avatar">
                                                            <img src="{{url('theme/images/notification_head4.png')}}" alt="">
                                                        </div>
                                                        <div class="info">
                                                            <p>
                                                                <span>Anderson</span> added to Favourite
                                        ...
                                        <div class="dropdown messaging--dropdown">
                                            ...
                                            <div class="messages">
                                                ...
                                                <a href="message.html" class="message recent">
                                                    <div class="message__actions_avatar">
                                                        <div class="avatar">
                                                            <img src="{{url('theme/images/notification_head5.png')}}" alt="">
                                                        </div>
                                                    </div>
                                                    <!-- end /.actions -->
                                                ...
                                                <a href="message.html" class="message">
                                                    <div class="message__actions_avatar">
                                                        <div class="avatar">
                                                            <img src="{{url('theme/images/notification_head6.png')}}" alt="">
                                                        </div>
                                                    </div>
                                                    <!-- end /.actions -->
                                            ...
                                            <div class="cart_area">
                                                <div class="cart_product">
                                                    <div class="product__info">
                                                        <div class="thumbn">
                                                            <img src="{{url('theme/images/capro1.jpg')}}" alt="cart product thumbnail">
                                                        </div>
                                                        ...
                                                        <div class="info">
                                                            ...
                                                            <div class="cat">
                                                                <a href="#">
                                                                    <img src="{{url('theme/images/catword.png')}}" alt="">Wordpress</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="cart_product">
                                                    <div class="product__info">
                                                        <div class="thumbn">
                                                            <img src="{{url('theme/images/capro2.jpg')}}" alt="cart product thumbnail">
                                                        </div>
                            ...
                            <div class="author-author__info inline has_dropdown">
                                <div class="author__avatar">
                                    <img src="{{url('theme/images/usr_avatar.png')}}" alt="user avatar">
                                    ...
                                    <ul>
                                        ...
                                        @if (Route::has('login'))
                                                ...
                                                @auth                        
                                                    <li>
                                                        <a href="{{ url('/home') }}">
                                                            <span class="lnr lnr-exit"></span>Dashboard</a>
                                                    </li>
                                                    <li>
                                                        <a href="author.html">
                                                    ...
                                                    @if (Route::has('register'))
                                                        <li>
                                                            <a href="{{ route('register') }}">
                                                                <span class="lnr lnr-exit"></span>Register</a>
                                                        </li>                            
                                                    @endif
                                                @endauth
...
=================================-->
    <section class="hero-area bgimage">
        <div class="bg_image_holder">
            <img src="{{url('theme/images/hero_area_bg1.jpg')}}" alt="background-image">
        </div>
        <!-- start hero-content -->
                    ...
                    <div class="row">
                        ...
                        <!-- end ./search_box -->
                            ...
                            <div class="hero__content__title">
                                ...
                                <p class="tagline">Create Your Own. <strong>Digital Product Marketplace</strong> </p>
                            </div>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="feature">
                        <div class="feature__img">
                            <img src="{{url('theme/images/feature1.png')}}" alt="feature">
                        </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="feature">
                        <div class="feature__img">
                            <img src="{{url('theme/images/feature2.png')}}" alt="feature">
                        </div>
                        <div class="feature__title">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="feature">
                        <div class="feature__img">
                            <img src="{{url('theme/images/feature3.png')}}" alt="feature">
                        </div>
                        <div class="feature__title">
                    ...
                    <div class="featured-product-slider prod-slider1">
                        <div class="featured__single-slider">
                            <div class="featured__preview-img">
                                <img src="{{url('theme/images/featprod.jpg')}}" alt="Featured products">
                                <div class="prod_btn">
                        ...
                        <div class="filter__menu">
                            ...
                            <div class="filter__menu_icon">
                                <a href="#" id="drop1" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <img class="svg" src="{{url('theme/images/svg/menu.svg')}}" alt="menu icon">
                                </a>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="product product--card">
                        ...
                        <div class="product__thumbnail">
                            <img src="{{url('theme/images/p1.jpg')}}" alt="Product Image">
                            <div class="prod_btn">
                                <a href="single-product.html" class="transparent btn--sm btn--round">More Info</a>
                                <a href="single-product.html" class="transparent btn--sm btn--round">Live Demo</a>
                            </div>
                        ...
                        <div class="product-desc">
                            ...
                            <ul class="titlebtm">
                                <li>
                                    <img class="auth-img" src="{{url('theme/images/auth.jpg')}}" alt="author image">
                                    <p>
                                        <a href="#">AazzTech</a>
                                    </p>
                                </li>
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="product product--card">
                        ...
                        <div class="product__thumbnail">
                            <img src="{{url('theme/images/p2.jpg')}}" alt="Product Image">
                            <div class="prod_btn">
                                <a href="single-product.html" class="transparent btn--sm btn--round">More Info</a>
                                <a href="single-product.html" class="transparent btn--sm btn--round">Live Demo</a>
                            </div>
                        ...
                        <div class="product-desc">
                            ...
                            <ul class="titlebtm">
                                <li>
                                    <img class="auth-img" src="{{url('theme/images/auth2.jpg')}}" alt="author image">
                                    <p>
                                        <a href="#">AazzTech</a>
                                    </p>
                                </li>
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="product product--card">
                        ...
                        <div class="product__thumbnail">
                            <img src="{{url('theme/images/p3.jpg')}}" alt="Product Image">
                            <div class="prod_btn">
                                <a href="single-product.html" class="transparent btn--sm btn--round">More Info</a>
                                <a href="single-product.html" class="transparent btn--sm btn--round">Live Demo</a>
                            </div>
                        ...
                        <div class="product-desc">
                            ...
                            <ul class="titlebtm">
                                <li>
                                    <img class="auth-img" src="{{url('theme/images/auth3.jpg')}}" alt="author image">
                                    <p>
                                        <a href="#">AazzTech</a>
                                    </p>
                                </li>
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="product product--card">
                        ...
                        <div class="product__thumbnail">
                            <img src="{{url('theme/images/p4.jpg')}}" alt="Product Image">
                            <div class="prod_btn">
                                <a href="single-product.html" class="transparent btn--sm btn--round">More Info</a>
                                <a href="single-product.html" class="transparent btn--sm btn--round">Live Demo</a>
                            </div>
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="product product--card">
                        ...
                        <div class="product__thumbnail">
                            <img src="{{url('theme/images/p5.jpg')}}" alt="Product Image">
                            <div class="prod_btn">
                                <a href="single-product.html" class="transparent btn--sm btn--round">More Info</a>
                                <a href="single-product.html" class="transparent btn--sm btn--round">Live Demo</a>
                            </div>
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="product product--card">
                        ...
                        <div class="product__thumbnail">
                            <img src="{{url('theme/images/p6.jpg')}}" alt="Product Image">
                            <div class="prod_btn">
                                <a href="single-product.html" class="transparent btn--sm btn--round">More Info</a>
                                <a href="single-product.html" class="transparent btn--sm btn--round">Live Demo</a>
                            </div>
...
=================================-->
    <section class="counter-up-area bgimage">
        <div class="bg_image_holder">
            <img src="{{url('theme/images/countbg.jpg')}}" alt="">
        </div>
        <!-- start .container -->
            ...
            <div class="row">
                <div class="col-md-6 no-padding">
                    <div class="proposal proposal--left bgimage">
                        <div class="bg_image_holder">
                            <img src="{{url('theme/images/bbg.png')}}" alt="prop image">
                        </div>
                ...
                <div class="col-md-6 no-padding">
                    <div class="proposal proposal--right">
                        <div class="bg_image_holder">
                            <img src="{{url('theme/images/sbg.png')}}" alt="this is magic">
                        </div>
                        <div class="content_above">
                            <div class="proposal__icon">
                ...
                <div class="col-md-12">
                    <div class="testimonial-slider">
                        <div class="testimonial">
                            <div class="testimonial__about">
                                <div class="avatar v_middle">
                                    <img src="{{url('theme/images/test1.jpg')}}" alt="Testimonial Avatar">
                                </div>
                        ...
                        <div class="testimonial">
                            <div class="testimonial__about">
                                <div class="avatar v_middle">
                                    <img src="{{url('theme/images/test2.jpg')}}" alt="Testimonial Avatar">
                                </div>
                                <div class="name-designation v_middle">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="news">
                        <div class="news__thumbnail">
                            <img src="{{url('theme/images/news1.png')}}" alt="News Thumbnail">
                        </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="news">
                        <div class="news__thumbnail">
                            <img src="{{url('theme/images/news2.png')}}" alt="News Thumbnail">
                        </div>
                        <div class="news__content">
                            <a href="#" class="news-title">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="special-feature feature--1">
                        <img src="{{url('theme/images/spf1.png')}}" alt="Special Feature image">
                ...
                <div class="col-md-6">
                    <div class="special-feature feature--2">
                        <img src="{{url('theme/images/spf2.png')}}" alt="Special Feature image">
...
=================================-->
    <section class="call-to-action bgimage">
        <div class="bg_image_holder">
            <img src="{{url('theme/images/calltobg.jpg')}}" alt="">
        </div>
        <div class="container content_above">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="info-footer">
                            <div class="info__logo">
                                <img src="{{url('theme/images/flogo.png')}}" alt="footer logo">
                            </div>
...
=================================-->
    ...
    <!-- inject:js -->
    <script src="{{asset('theme/js/vendor/jquery/jquery-1.12.3.js')}}"></script>
    <script src="{{asset('theme/js/vendor/jquery/uikit.min.js')}}"></script>
    <script src="{{asset('theme/js/vendor/jquery/popper.min.js')}}"></script>
    <script src="{{asset('theme/js/vendor/bootstrap.min.js')}}"></script>
    <script src="{{asset('theme/js/vendor/chart.bundle.min.js')}}"></script>
    <script src="{{asset('theme/js/vendor/grid.min.js')}}"></script>
    <script src="{{asset('theme/js/vendor/jquery-ui.min.js')}}"></script>
    <script src="{{asset('theme/js/vendor/jquery.barrating.min.js')}}"></script>
    <script src="{{asset('theme/js/vendor/jquery.countdown.min.js')}}"></script>
    <script src="{{asset('theme/js/vendor/jquery.counterup.min.js')}}"></script>
    <script src="{{asset('theme/js/vendor/jquery.easing1.3.js')}}"></script>
    <script src="{{asset('theme/js/vendor/owl.carousel.min.js')}}"></script>
    <script src="{{asset('theme/js/vendor/slick.min.js')}}"></script>
    <script src="{{asset('theme/js/vendor/tether.min.js')}}"></script>
    <script src="{{asset('theme/js/vendor/trumbowyg.min.js')}}"></script>
